...
Simple linear regression was used to explore the relationship between juvinile snowshoe hare foot hind foot length (mm) and body mass (g) across all three sampling sites, and including both male and female hares. A significant regression model was found ($\beta$ = `r round(bonanza_coef,3)`, F(`r bonanza_lm_out$df`,`r bonanza_lm_out$df.residual`) = `r round(bonanza_lm_out$statistic,1)`, p < 0.001) with an R^2^ of `r round(bonanza_lm_out$r.squared,3)`.
